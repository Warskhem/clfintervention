    ...
    if (intvBlock === blockLower && intvCLF === clfLower) {
      if (intv.name || intv.brief || intv.image) {
        return {
          ...
          cifFund: intv.cifFund,
          vrfFund: intv.vrfFund,
          startupFund: intv.startupFund,
          bankLoan: intv.bankLoan,
          bc: intv.bc,
